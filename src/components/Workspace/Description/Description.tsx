...
import type { DBProblem, Problem } from '@/utils/types/problem'
...
const Description: FC<Props> = ({ problem, success }) => {
    ...
    const fetchData = async () => {
      ...
      if (docSnap.exists()) {
        ...
        if (problem.difficulty === 'Easy') {
          ...
          classname = 'bg-dark-yellow text-dark-yellow'
        } else {
          classname = 'bg-dark-pink text-dark-pink'
        }
        setProblemDifficultyClass(classname)
      }
      setLoading(false)
    }
    fetchData()
